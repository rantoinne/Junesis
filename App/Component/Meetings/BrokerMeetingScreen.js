...
class BrokerMeetingScreen extends Component{
constructor(props){
  super(props)
  this.state = {
        ...
        <SafeAreaView style={{flex: 1}}> 
            <View style={{height: 50, backgroundColor: "#2A2A2A", 
                ...
                <View style={{justifyContent: "center", flex: 3}}>
                    <Text style={{color: "#FFFFFF", fontSize: 15}}>I AM PARTNER</Text>
                </View>
            ...
            <ScrollView>
                <View style={{padding: 30, flex: 1}}>
                    <View>
                        ...
                        <Text style={{color: "#A3A3A3", fontSize: 15, marginTop: 12}}>Buyer/Client Name</Text>
                    ...
                    <View style={{marginTop: 30}}>
                        ...
                        <View style={{marginTop: 30}}>
                            <TouchableOpacity style={{backgroundColor: "#F6F6F6", height: 82, width: 97, justifyContent: "center", alignItems: "center"}}
                                        onPress={() => alert("camera")}>  
                                <Image source={icon_camera} style={{height: 29, width: 37}} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
...
export default BrokerMeetingScreen;
