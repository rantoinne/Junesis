...
const ico_meeting_clock = require("../../../assets/images/ico_meeting_clock.png")
...
onSwipe(gestureName, gestureState) {
  ...
  goByUserType = (demo) => {
if(demo == "u"){
    this.props.navigation.navigate('BuyerMeetingScreen');
}if(demo == "b"){
    this.props.navigation.navigate('BrokerMeetingScreen');
}
    // if(this.state.userType === "Buyer"){
    //     goToScreen("Junesis.BuyerMeetingScreen")
    // }else{
    //     goToScreen("Junesis.BrokerMeetingScreen")
    // }
  }
        ...
        <SafeAreaView style={{flex: 1}}> 
            <View style={{height: 50, backgroundColor: "#2A2A2A", 
                ...
                <View style={{justifyContent: "center", flex: 3}}>
                    <Text style={{color: "#FFFFFF", fontSize: 15}}>MEETINGS</Text>
                </View>
            ...
            <ScrollView style={{flex: 1}}>
                <View style={{flex: 1, }}>
                    <TouchableOpacity onPress={() => this.goByUserType("b")}>
                        <View style={{height: 137, flexDirection: "row", paddingHorizontal: 20, paddingVertical: 10, backgroundColor: "#FFFFFF"}}>
                            <View style={{flex: 1, alignItems: "center"}}>
                                <Image source={ico_meeting_clock} style={{height: 33, width: 33}} resizeMode= "stretch" />
                            </View>
                            <View style={{flex: 4}}>
                                <View>
                                    <Text style={{color: "#535353", fontSize: 16}}>Meeting Scheduled</Text>
                                    <Text style={{color: "#A3A3A3", fontSize: 14, marginTop: 5}}>12th September 2019</Text>
                                    <Text style={{color: "#A3A3A3", fontSize: 14}}>8.00 PM</Text>
                                </View>
                                <View style={{marginTop: 14}}>
                                    <Text style={{color: "#535353", fontSize: 16}}>White-mills Estate</Text>
                                    <Text style={{color: "#A3A3A3", fontSize: 14, marginTop: 5}}>Meet at Property</Text>
                                </View>
                            </View>
                        </View>
                    </TouchableOpacity>    
                    ...
                    <TouchableOpacity onPress={() => this.goByUserType("u")}>
                        <View style={{height: 137, flexDirection: "row", paddingHorizontal: 20, paddingVertical: 10, backgroundColor: "#FFFFFF"}}>
                            <View style={{flex: 1, alignItems: "center"}}>
                                <Image source={ico_meeting_clock} style={{height: 33, width: 33}} resizeMode= "stretch" />
                            </View>
